...
const useCart =(productData)=>{
    ...
    return {progress,isSpinning,fetchCart,checkout,productData,modifyQty,getProductData,err,cartMessage,variants,getCart,emptyCart,setVariants,options,handleOptions,removeItem,isEmpty,cart,initialRequest,openCart,closeCart,cartOpen};
}
