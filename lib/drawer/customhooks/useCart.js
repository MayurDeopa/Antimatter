...
const useCart =()=>{
    ...
    return {isSpinning,fetchCart,checkout,data,modifyQty,getProductData,err,cartMessage,variants,getCart,emptyCart,setVariants,options,handleOptions,removeItem,isEmpty,cart,initialRequest};
}
