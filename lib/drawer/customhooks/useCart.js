...
const useCart =()=>{
    const {userState,progressState,cartState,cartLoader} = useStore()
    ...
    return {isSpinning,fetchCart,checkout,data,modifyQty,getProductData,err,cartMessage,variants,getCart,emptyCart,setVariants,options,handleOptions,removeItem};
}
