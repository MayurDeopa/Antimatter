...
const usePayment =()=>{
  const router = useRouter()
    ...
    return {paymentGateways,isPaying,data,setData,setInput,generateToken,checkoutData,fetchCountries,countriesData,fetchStates,states,handleCheckoutCapture,err,isFetching,makePayment,handlePayment,applyDiscount,applyingDiscount,getOrder,isOrderSucessfull}
}
