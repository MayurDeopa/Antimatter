...
const usePayment =()=>{
    ...
    const makePayment = async(params,userData)=>{
      ...
      try{
        ...
        const options = {
          key:  __DEV_()?"rzp_test_Xo7VXINAoloD9k":process.env.RAZORPAY_KEY_ID,
    ...
    return {paymentGateways,isPaying,data,setData,setInput,generateToken,checkoutData,fetchCountries,countriesData,fetchStates,states,handleCheckoutCapture,err,isFetching,makePayment,handlePayment}
}
